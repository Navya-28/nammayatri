...
data RiderConfigT f = RiderConfigT
  { appUrl :: (B.C f Kernel.Prelude.Text),
    ...
    busTrackingNotificationTiers :: (B.C f (Kernel.Prelude.Maybe [BecknV2.FRFS.Enums.ServiceTierType])),
    ...
    immediateCaptureRiderCancellationFee :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
    ...
    maxWalkDistanceForBetterPoint :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Meters)),
    ...
    nonAllowedOverrideFleetNoServiceTiers :: (B.C f (Kernel.Prelude.Maybe Data.Aeson.Value)),
    ...
    seatBookingTtl :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
