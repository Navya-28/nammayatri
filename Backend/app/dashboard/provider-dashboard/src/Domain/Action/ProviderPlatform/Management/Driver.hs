...
getDriverLoginOtp :: ShortId DM.Merchant -> City.City -> ApiTokenInfo -> Maybe Text -> Maybe Text -> Flow Common.DriverLoginOtpRes
getDriverLoginOtp merchantShortId opCity apiTokenInfo mbMobileNumber mbMobileCountryCode = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callManagementAPI checkedMerchantId opCity (.driverDSL.getDriverLoginOtp) mbMobileNumber mbMobileCountryCode
