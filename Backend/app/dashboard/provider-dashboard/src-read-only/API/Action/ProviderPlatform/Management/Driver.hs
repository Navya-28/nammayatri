...
getDriverLoginOtp :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.DriverLoginOtpRes)
getDriverLoginOtp merchantShortId opCity apiTokenInfo mobileNumber mobileCountryCode = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.getDriverLoginOtp merchantShortId opCity apiTokenInfo mobileNumber mobileCountryCode
